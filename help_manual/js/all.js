...
DR_EXPLAIN.data_menu = {
	// menu
	DREX_NODE_NAMES: ["Database Diff-Tool Help Manual","Getting Started","Database Connection","Database Data Displaying","File Viewing","Table Filter","Comparison","Database Connection Dialogue ","List View","Table Content View","View file as .txt","View file in HTML","Comparison Output diagrammed","Comparison Output as download"],
	DREX_NODE_LINKS: ["index.htm","getting_started.htm","database_connection.htm","database_data_displaying.htm","file_viewing.htm","table_filter.htm","comparison.htm","database_connection_dialogue_.htm","list_view.htm","table_content_view.htm","view_file_as__txt.htm","view_file_in_html.htm","comparison_output_diagrammed.htm","comparison_output_as_download.htm"],
	DREX_NODE_CHILD_START: [1,7,7,8,10,12,12,14,14,14,14,14,14,14],
	DREX_NODE_CHILD_END: [7,7,8,10,12,12,14,14,14,14,14,14,14,14],
	DREX_MENU_TYPE: 1,
...
DR_EXPLAIN.data_resize = {
	...
	DREXPLAIN_FIT_HEIGHT_TO_WINDOW: (is_touch_device() ? 0 : 0),
